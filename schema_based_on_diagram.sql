...
CREATE TABLE medical_histories_treatments (id SERIAL PRIMARY KEY NOT NULL, medical_history__id int references medical_histories(id),  treatments__id int references treatments(id),status VARCHAR(100) );
